...
每个已实现任务都有对应的 `tests/validate_tXX.gd`。例如运行 T24：

```powershell
godot --headless --path . --script res://tests/validate_t24.gd
```
